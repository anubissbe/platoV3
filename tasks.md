...
- [x] Fix MemoryManager test failures in src/**tests**/memory.test.ts
...
- [x] Fix config loading and merging logic in src/**tests**/unit/config.test.ts
...
- [x] Fix slash command parsing and validation in src/**tests**/slash-commands.test.ts
...
- [x] Fix mouse event processing in src/**tests**/mouse-event-handler.test.ts
...
- [x] Fix real config validation in src/**tests**/integration/permissions-real-config.test.ts
...
- [x] Fix write tool failures in src/tools/native/**tests**/write-tool.test.ts
- [x] Resolve edit tool issues in src/tools/native/**tests**/edit-tool.test.ts
- [x] Fix directory tools failures in src/tools/native/**tests**/directory-tools.test.ts
...
- [x] Fix permission loading and validation in src/**tests**/unit/tools/permissions.test.ts
...
- [x] Fix thread management in src/**tests**/integration/thread-preservation-integration.test.ts
...
- [x] Fix GitHub Actions workflow validation in src/**tests**/ci/ci-config.test.ts
