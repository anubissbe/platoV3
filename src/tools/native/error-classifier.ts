...
export class ErrorClassifier {
  ...
  private static readonly ERROR_MAPPINGS: Record<
    string,
    {
      errorClass: ErrorClass;
      retryable: boolean;
  ...
  private static readonly DEFAULT_RETRY_POLICIES: Record<
    ErrorClass,
    RetryPolicy
  > = {
  ...
  static classifyError(
    error: Error | string | { code?: string; errno?: number },
   ...
   */
  private static standardizeErrorMessage(
    code: string,
