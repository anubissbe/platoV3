  ...
  describe('NativeToolExecutor', () => {
    ...
    describe('MCP Fallback Logic', () => {
      ...
      it('should use MCP when forceMCP config is enabled', async () => {
        ...
        const forceMCPExecutor = new NativeToolExecutor(configWithForceMCP, mockMCPBridge);
      ...
      it('should handle MCP bridge errors gracefully', async () => {
        mockMCPBridge.execute.mockRejectedValue(new Error('MCP connection failed'));
        ...
        await expect(toolExecutor.execute(toolCall)).rejects.toThrow('MCP connection failed');
      });
    });
    ...
    describe('Configuration and Resource Management', () => {
      it('should respect timeout configuration', async () => {
        ...
        const shortTimeoutExecutor = new NativeToolExecutor(shortTimeoutConfig, mockMCPBridge);
        const bashTool = new BashTool(tempDir);
      ...
      it('should respect concurrency limits', async () => {
        ...
        const limitedExecutor = new NativeToolExecutor(lowConcurrencyConfig, mockMCPBridge);
        const bashTool = new BashTool(tempDir);
    ...
    describe('Schema Validation', () => {
      ...
      it('should validate tool call format', async () => {
        ...
        await expect(toolExecutor.execute(invalidToolCall)).rejects.toThrow('Invalid tool call format');
      });
      ...
      it('should validate tool names', async () => {
        ...
        await expect(toolExecutor.execute(invalidToolCall)).rejects.toThrow('Tool name cannot be empty');
      });
    });
