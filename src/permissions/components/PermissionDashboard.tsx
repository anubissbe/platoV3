...
export const PermissionDashboard: React.FC<PermissionDashboardProps> = ({
  ...
  const renderOverview = () => (
    <Box flexDirection="column">
      <Text bold color="yellow">Permission System Overview</Text>
      <Box marginTop={1}>
  ...
  const renderProfiles = () => (
    <Box flexDirection="column">
      <Text bold color="yellow">Profiles</Text>
  ...
  const renderAuditLog = () => (
    <Box flexDirection="column">
      <Text bold color="yellow">Recent Audit Entries</Text>
  ...
  const renderHelp = () => (
    <Box flexDirection="column">
      <Text bold color="yellow">Permission System Help</Text>
