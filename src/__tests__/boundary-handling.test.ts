...
describe("Scroll Boundary Handling", () => {
  ...
  beforeEach(() => {
    ...
    scrollController.on("bounceComplete", (event) =>
      bounceCompleteEvents.push(event),
    );
  ...
  describe("Boundary Detection", () => {
    ...
    test("should detect when at bottom boundary", () => {
      const maxScroll =
        conversationRenderer.getTotalHeight() -
        conversationRenderer.getViewportHeight();
  ...
  describe("Boundary Events", () => {
    ...
    test("should not emit boundary events when feedback is disabled", () => {
      ...
      noFeedbackController.on("boundary", (event) =>
