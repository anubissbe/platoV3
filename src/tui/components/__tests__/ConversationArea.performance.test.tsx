  ...
  describe("Text Processing Performance", () => {
    it("handles long messages with text wrapping efficiently", () => {
      const longMessage = {
        role: "assistant" as const,
        content:
          "This is an extremely long message that contains a lot of text and should be wrapped properly across multiple lines without causing performance issues. ".repeat(
            10,
          ),
        timestamp: Date.now(),
        metadata: {},
