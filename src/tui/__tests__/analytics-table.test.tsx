...
describe("AnalyticsTable", () => {
  ...
  describe("Basic Rendering", () => {
    it("should render table with metrics", () => {
      const { lastFrame } = render(<AnalyticsTable metrics={mockMetrics} />);
    ...
    it("should render empty state when no metrics", () => {
      const { lastFrame } = render(<AnalyticsTable metrics={[]} />);
  ...
  describe("Sorting", () => {
    it("should sort by timestamp descending by default", () => {
      ...
      const dataLines = lines.filter(
        (line) => line.includes("gpt") || line.includes("claude"),
      );
  ...
  describe("Totals", () => {
    it("should show totals when enabled", () => {
      const { lastFrame } = render(
        <AnalyticsTable metrics={mockMetrics} showTotals={true} />,
      );
    ...
    it("should hide totals when disabled", () => {
      const { lastFrame } = render(
        <AnalyticsTable metrics={mockMetrics} showTotals={false} />,
      );
  ...
  describe("Formatting", () => {
    it("should format currency based on value ranges", () => {
      ...
      const { lastFrame } = render(<AnalyticsTable metrics={testMetrics} />);
